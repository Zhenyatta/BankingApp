...
const formaMovementDate = function (date, locale) {
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const displayDate = formaMovementDate(date, acc.locale);
...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    //when 0 seconds stop timer log out users
    if (time === 0) {
      clearInterval(timer);
...
// //parsing
// console.log(Number.parseInt("30ox", 10));
...
//   (ing1, ing2) => console.log(`here is ur pizza with ${ing1}, ${ing2}`),
//   3000,
//   ...ing
// );
